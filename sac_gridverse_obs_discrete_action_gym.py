...
from common.utils_gym import make_gridverse_env, save, set_seed
...
if __name__ == "__main__":
    ...
    if args.autotune:
        target_entropy = -0.8 * torch.log(1 / torch.tensor(env.action_space.n))
        if args.resume:
    ...
    for global_step in range(start_global_step, args.total_timesteps):
        ...
        if "TimeLimit.truncated" in info:
            ...
            truncated = False
        terminated = bool(done * (1 - truncated))
